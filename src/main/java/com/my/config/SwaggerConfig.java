    ...
    public OpenAPI openAPI() {
        ...
        Components components = new Components()
                ...
                .addSchemas("ErrorResponse", new Schema<>()
                        .addProperties("message", new StringSchema().example("Error message"))
                        .addProperties("errorCode", new StringSchema().example("ERROR_CODE"))
                        .addProperties("statusCode", new IntegerSchema().example(400))
                );
        return new OpenAPI()
